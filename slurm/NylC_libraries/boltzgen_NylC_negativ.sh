...
#SBATCH --job-name=bg_NylC_negativ
#SBATCH --output=/work/%u/slurm/logs/bg_NylC_negative/bg_NylC_negative_%j.out
#SBATCH --error=/work/%u/slurm/logs/bg_NylC_negative/bg_NylC_negative_%j.err
