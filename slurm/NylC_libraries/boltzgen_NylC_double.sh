...
#SBATCH --job-name=bg_NylC_double
#SBATCH --output=/work/%u/slurm/logs/bg_NylC_double/bg_NylC_double_%j.out
#SBATCH --error=/work/%u/slurm/logs/bg_NylC_double/bg_NylC_double_%j.err
...
NAME="NylC_double"
CONFIG="NylC/run/NylC_double.yaml"
